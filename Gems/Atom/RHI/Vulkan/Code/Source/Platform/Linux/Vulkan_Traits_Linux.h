...
#define AZ_TRAIT_ATOM_AZSL_SHADER_HEADER "Builders/ShaderHeaders/Platform/Linux/Vulkan/AzslcHeader.azsli"
#define AZ_TRAIT_ATOM_AZSL_PLATFORM_HEADER "Builders/ShaderHeaders/Platform/Linux/Vulkan/PlatformHeader.hlsli"
